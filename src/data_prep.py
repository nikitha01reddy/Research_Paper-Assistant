...
# Cap the number of papers we process. Capping at 1,000 papers ensures
# embedding generation and FAISS indexing completes in seconds on CPU.
# Set this to 50,000 for the full production run.
MAX_PAPERS = 1_000
